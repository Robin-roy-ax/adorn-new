      ...
      items: [
        {
          ...
          description:
            "Picasso Fusion crafted a cutting-edge website for Harmony Beats, featuring immersive visuals, seamless navigation, and compelling content that showcases the brand's diverse Dribble of music and artists. The website was meticulously designed to deliver an exceptional user experience across all devices, ensuring seamless interaction for visitors.",
        },
        {
